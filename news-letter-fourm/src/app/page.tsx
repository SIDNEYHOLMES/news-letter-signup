...
export default function Home() {
  return (
    ...
    <main className="bg-white flex flex-col h-screen items-center md:fixed md:flex md:flex-row-reverse md:justify-center md:h-5/6 md:w-[600] md:p-8 md:rounded-lg">
        <Image
        className='md:hidden'
        priority
        src={signupMobile}
